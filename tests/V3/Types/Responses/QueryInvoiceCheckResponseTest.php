...
test('create query-invoice-check-response from xml', function () {
    $responseXml = loadTestResponse('QueryInvoiceCheckResponse');

    $response = QueryInvoiceCheckResponse::fromXml($responseXml);
