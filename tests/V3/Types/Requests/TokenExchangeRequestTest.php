...
test('toXml', function () {
    $header = new BasicHeaderType([
        ...
        'timestamp' => '2021-09-20T19:16:05.000Z',
        'requestVersion' => '3.0',
        'headerVersion' => '1.0',
    ]);
