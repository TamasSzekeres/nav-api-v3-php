 ...
 */
final class LineType extends BaseType
{
    /**
    ...
    /**
     * @var array<int> Hivatkozások kapcsolódó tételekre, ha ez az ÁFA törvény alapján szükséges.
     */
    #[SkipWhenEmpty]
    #[Type('array<int>')]
    ...
    /**
     * @var array<ProductCodeType> Termékkódok.
     */
    #[SkipWhenEmpty]
